                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="link.name" placeholder="العنوان الظاهر على الزر"
                                           name="name"
                            ...
                            <div class="card-footer">
                                <button class="btn btn-outline-danger" @click="deleteLink(link.id, idx)"
                                        :disabled="submiting">
                                    <i class="fas fa-spinner fa-spin" v-if="submiting"></i>
                                    حذف اللينك
                                </button>
                                <button class="btn btn-secondary float-left" @click="updateLink(link)"
                                        :disabled="submiting">
                                    <i class="fas fa-spinner fa-spin" v-if="submiting"></i>
                                    حفظ التعديلات
                                </button>
